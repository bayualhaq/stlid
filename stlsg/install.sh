...
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlsg/stlsg.sh" -O /usr/bin/stlsg
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlsg/gproxy.sh" -O /usr/bin/gproxy
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlsg/autorekonek-stlsg.sh" -O /usr/bin/autorekonek-stlsg
...
chmod +x /usr/bin/stlsg
chmod +x /usr/bin/autorekonek-stlsg
rm -r ~/*.ipk
rm -r ~/install.sh
mkdir -p ~/akun/
mkdir -p ~/.ssh/
touch ~/akun/ssl.conf
touch ~/.ssh/config
touch ~/akun/stlsg.txt
sleep 2
echo "install selesai"
echo "untuk memulai tools silahkan jalankan perintah 'stlsg'"
