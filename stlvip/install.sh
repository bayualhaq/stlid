...
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlvip/stlvip.sh" -O /usr/bin/stlvip
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlvip/gproxy.sh" -O /usr/bin/gproxy
wget --no-check-certificate "https://raw.githubusercontent.com/bayualhaq/stlid/main/stlvip/autorekonek-stlvip.sh" -O /usr/bin/autorekonek-stlvip
...
chmod +x /usr/bin/stlvip
chmod +x /usr/bin/autorekonek-stlvip
rm -r ~/*.ipk
rm -r ~/install.sh
mkdir -p ~/akun/
mkdir -p ~/.ssh/
touch ~/akun/ssl.conf
touch ~/.ssh/config
touch ~/akun/stlvip.txt
sleep 2
echo "install selesai"
echo "untuk memulai tools silahkan jalankan perintah 'stlvip'"
